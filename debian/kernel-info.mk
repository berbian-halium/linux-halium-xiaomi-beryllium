...
# Kernel base version
KERNEL_BASE_VERSION = 4.9.200-1

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE =  console=ttyMSM0,115200n8 androidboot.console=ttyMSM0 earlycon=msm_geni_serial,0xA84000 androidboot.hardware=qcom androidboot.usbcontroller=a600000.dwc3 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 service_locator.enable=1 swiotlb=2048 androidboot.configfs=true loop.max_part=7 sched_enable_hmp=1 sched_enable_power_aware=1 console=tty0 systemd.unified_cgroup_hierarchy=0 droidian.lvm.prefer 

#KERNEL_BOOTIMAGE_CMDLINE =  earlycon=msm_serial_dm,0xc170000 androidboot.hardware=qcom androidboot.memcg=1 androidboot.usbcontroller=a800000.dwc3 androidboot.configfs=true lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_ehci-hcd.park=3 msm_rtb.filter=0x37 service_locator.enable=1 swiotlb=2048 buildvariant=userdebug console=tty0 firmware_class.path=/vendor/firmware_mnt/image loop.max_part=7 sched_enable_hmp=1 sched_enable_power_aware=1 panic_on_err=1 androidboot.selinux=permissive buildproduct=bahamut_dsds cgroup.memory=nokmem systemd.unified_cgroup_hierarchy=0 droidian.lvm.prefer
#user_debug=31
#firmware_class.path=/vendor/firmware firmware_class.path=/vendor/firmware_mnt/image 
#androidboot.avb_version=1.0 androidboot.vbmeta.avb_version=1.0
#printk.devkmsg=on 
#apparmor=1 security=apparmor
#msm_ehci-hcd.park=3 ehci-hcd.park=3
#datapart=/dev/mmcblk0p72
...
DEB_TOOLCHAIN = device-tree-compiler, linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang-android-6.0-4691093, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
